...
try {
    ...
    $app->get('/orders/user/{user_id}', [$orderController, 'getByUserId']);
    ...
    $app->post('/users/{username}/shopping_cart/{productId}/quantity/{quantity}', [$cartController, 'addItemToShoppingCart']);
    $app->put('/users/{username}/shopping_cart_quantity/{productId}', [$cartController, 'updateItemQuantityInShoppingCart']);
    $app->delete('/users/{username}/shopping_cart/{productId}', [$cartController, 'deleteItemFromShoppingCart']);
    $app->delete('/users/{username}/shoppingcart', [$cartController, 'deleteCart']);
    $app->get('/users/{username}/showcart', [$cartController, 'getShoppingCart']);
